...
function SignUp() {
  ...
  const handleSignUp=async() => {
    try {
      ...
      // ✅ Fixed: logs full error details so you can see them clearly in Inspect > Console
  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center p-4' style=
      ...
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
        ...
        <p className='text-gray-600 mb-8'>Create your acoount to get started with delicious food deliveries</p>
        ...
        <div className='mb-4'>
          ...
          <input type="tel" className='w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-orange-500' placeholder='Enter your mobile no' style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setMobile(e.target.value)} value={mobile}/>
        </div>
